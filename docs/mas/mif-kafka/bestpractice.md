...
- Increasing the number of partitions may result in better performance for small messages (e.g. 10 assets per message) compared to large messages. Please ensure that there are an adequate number of messages in the queue for processing.
